...
TARGET_BOOTLOADER_BOARD_NAME := Hiphop
...
# Kernel
TARGET_PREBUILT_KERNEL := device/acer/acer_Z520/kernel
BOARD_KERNEL_CMDLINE := 
BOARD_CUSTOM_BOOTIMG_MK := device/acer/acer_Z520/mkbootimg.mk
...
# TWRP-Specific
TARGET_RECOVERY_FSTAB := device/acer/acer_Z520/recovery/root/etc/twrp.fstab
BOARD_SUPPRESS_SECURE_ERASE := true
RECOVERY_GRAPHICS_USE_LINELENGTH := true
TW_THEME := portrait_mdpi
RECOVERY_SDCARD_ON_DATA := true
TTW_INTERNAL_STORAGE_PATH := "/data/media"
